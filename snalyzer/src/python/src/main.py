...
def resolve_topics(question_contents, question_topics):
    ...
    #Note: The original work by Sammit Jain at https://github.com/sammitjain/loksabha-questions resolves only for the 2021 sessions. The changes needed to cover all edge cases from all sessions since 2020 for the purposes of my project has not been included in my repo as it is very messy (and more importantly, having lost them in a data crash with only the generated CSVs on hand).
